...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Slideshow | Holy Gardens Matutum Memorial Park</title>
              ...
              <div class="bg-white p-4 h-100 rounded">
                <div class="title-header bg-white sticky-top p-3 d-flex">
                  <h4 class="d-flex align-items-center">
                    ...
                    &nbsp;Slideshow Setup</h4>
                    <button class="btn btn-success edit-news d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#slideshowmodal">
    ...
    <div class="modal-content">
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-footer">
            <button type="submit" name="btn-submit-slideshow" id="btn-submit-slideshow" class="btn btn-success">Add</button>
    ...
    <div class="modal-dialog modal-dialog-centered  modal-lg">
      <div class="modal-content">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
          ...
          <div class="modal-footer">
              <button type="submit" name="btn-edit-slideshow-announce" id="btn-edit-slideshow" class="btn btn-success">Update</button>
    ...
    <div class="modal-dialog modal-dialog-centered  modal-lg">
      <div class="modal-content">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
          ...
          <div class="modal-footer">
              <button type="submit" name="btn-edit-slideshow-banner" id="btn-edit-slideshow-banner" class="btn btn-success">Update</button>
