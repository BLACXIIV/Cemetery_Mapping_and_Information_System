...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Customer | Holy Gardens Matutum Memorial Park</title>
              ...
              <div class="col-sm-12 col-md-12">
                ...
                <div class="title-header bg-white sticky-top p-3 d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center">
                        <a href="alert.php" style="margin-right: 10px;" title=" Click to Alert Customer">
                            <img src="../Assets/image/alert.png" alt="" style="height: 30px;">
                        </a>
                        <button class="btn btn-success add-customer d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#add-customer">
                ...
                <div class="modal-content">
                  ...
                  <form action="" method="post">
                    ...
                    <div class="modal-footer">
                      <button type="submit" name="btn-submit-customer" id="btn-submit-customer" class="btn btn-success">Register</button>
