...
<head>
    ...
    <title>Block and Lot Setup | Holy Gardens Matutum Memorial Park</title>
                                                    ...
                                                    <div class="col-sm-12 col-md-12">
                                                        <div class="bg-white p-3 h-100 rounded">
                                                            <div class="title-header bg-white sticky-top p-3 d-flex">
                                                                ...
                                                                <button class="btn btn-success add-customer d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#add-site">
                                                        ...
                                                        <div class="bg-white p-3 h-100 rounded">
                                                            <div class="title-header bg-white sticky-top p-3 d-flex">
                                                                <h5 class="d-flex align-items-center">
                                                                    ...
                                                                    &nbsp;List of Blocks</h5>
                                                                <button class="btn btn-success add-customer d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#add-block">
                                                                    <i class='bx bx-plus fs-4'></i> 
                                                                    &nbsp;New Block
                                                                </button>
                                                            </div> 
                                                        ...
                                                        <div class="bg-white p-3 h-100 rounded">
                                                            <div class="title-header bg-white sticky-top p-3 d-flex">
                                                                <h5 class="d-flex align-items-center">
                                                                    ...
                                                                    &nbsp;List of Lots</h5>
                                                                <button class="btn btn-success add-customer d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#add-lot">
                                                                    <i class='bx bx-plus fs-4'></i> 
                                                                    &nbsp;New Lot
                                                                </button>
                                                            </div> 
            ...
            <div class="modal-content">
                ...
                <form action="" method="post">
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="btn-submit-site" id="btn-submit-site" class="btn btn-success">Add</button>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg"> 
            <div class="modal-content">
                ...
                <form action="" method="post">
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="btn-submit-block" id="btn-submit-block" class="btn btn-success">Add</button>
                        <button type="reset" class="btn btn-danger">Reset</button> 
                    </div>
                </form>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg"> 
            <div class="modal-content">
                ...
                <form action="" method="post">
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="btn-submit-lot" id="btn-submit-lot" class="btn btn-success">Add</button>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg"> 
                <div class="modal-content">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="modal-footer">
                            <button type="submit" name="btn-update-site" id="btn-update-site" class="btn btn-success">Update</button>
                            <button type="reset" class="btn btn-danger">Reset</button> 
                        </div>
                    </form>
                </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg"> 
                <div class="modal-content">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="modal-footer">
                            <button type="submit" name="btn-update-block" id="btn-update-block" class="btn btn-success">Update</button>
                            <button type="reset" class="btn btn-danger">Reset</button> 
                        </div>
                    </form>
                </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg"> 
                <div class="modal-content">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="modal-footer">
                            <button type="submit" name="btn-update-lot" id="btn-update-lot" class="btn btn-success">Update</button>
                            <button type="reset" class="btn btn-danger">Reset</button> 
                        </div>
                    </form>
                </div>
