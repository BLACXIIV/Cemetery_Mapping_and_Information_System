...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Alert | Holy Gardens Matutum Memorial Park</title>
...
<body>
  ...
  <div class="sidebar close">
    ...
    <div class="logo-details">
      <img src="../Assets/image/logopngplain1.png" alt="">
    </div>
    ...
    <ul class="nav-links">
      ...
      <li class="tabs" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Services">
        <a href="services.php">
              ...
              <div class="col-sm-12 col-md-12">
                ...
                <div class="title-header bg-white sticky-top p-3 d-flex justify-content-between align-items-center">  
                    ...
                    <div class="d-flex align-items-center">
                        <a href="customer.php" style="margin-right: 10px;" title="Click to Add Customer">
                            <img src="../Assets/image/add.png" alt="" style="height: 30px;">
                        </a>
                        <button class="btn btn-success add-customer d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#alert-customer">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="text-center align-middle">
                            <button class="btn btn-success mb-1" id="btn-select" data-bs-toggle="modal" data-bs-target="#select-owner<?php echo $row["customer_id"]?>">
                              <i class='bx bx-layer' ></i>
                            </button>
...
<!------------------------- MODALS ADD CUSTOMER --------------------------------------->
            <div class="modal fade" id="alert-customer" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="send_alert.php" method="post">
                <div class="modal-body p-4">
                    <div class="mb-3">
                        <label for="alert-subject" class="form-label">Subject:</label>
                        <input type="text" class="form-control" id="alert-subject" name="subject" required>
                    </div>
                    <div class="mb-3">
                        <label for="alert-message" class="form-label">Message:</label>
                        <textarea class="form-control" id="alert-message" name="message" rows="6" required></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="submit" name="send-alert" class="btn btn-success">Send Alert</button>
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl"> 
      <div class="modal-content">
        ...
        <form action="" method="post">
          ...
          <div class="modal-footer">
            <button type="submit" class="btn btn-success" name="btn-update" id="btn-update">Update</button>
...
<?php }?>
 <script type="text/javascript">
    ...
    $('#alert-customer').on('hidden.bs.modal', function () {
        $(this).find('form')[0].reset();
    });
    
    // Optional: Add character counter for message
    $('#alert-message').on('input', function() {
        let maxLength = 5000; // Set your desired max length
