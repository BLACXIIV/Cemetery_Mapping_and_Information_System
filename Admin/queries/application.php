...
if(isset($_POST['btn-add-service'])){
  $name = $con->real_escape_string($_POST['service-name']);
  $price = $con->real_escape_string($_POST['service-price']);
  $description = $con->real_escape_string($_POST['service-description']);
  
  $query = "INSERT INTO `memorial_services` 
...
// Request Service
if(isset($_POST['btn-request-service'])){
  $customer_id = $con->real_escape_string($_POST['customer-id']);
  $service_id = $con->real_escape_string($_POST['service-id']);
  $request_date = $con->real_escape_string($_POST['request-date']);
  $notes = $con->real_escape_string($_POST['additional-notes']);
  
  $query = "INSERT INTO `service_requests` 
            (`customer_id`, `service_id`, `request_date`, `additional_notes`) 
            VALUES 
            ('$customer_id', '$service_id', '$request_date', '$notes')";
