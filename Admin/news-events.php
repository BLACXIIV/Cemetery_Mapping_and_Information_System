...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <link rel="shortcut icon" href="../Assets/image/logo1.png" type="image/x-icon">
    <title>News and Events | Holy Gardens Matutum Memorial Park</title>
              ...
              <div class="bg-white p-4 h-100 rounded">
                <div class="title-header bg-white sticky-top p-3 d-flex">
                  <h4 class="d-flex align-items-center">
                    ...
                    <button class="btn btn-success edit-news d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#newsmodal">
    ...
    <div class="modal-content">
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-footer">
            <button type="submit" name="btn-submit-news" id="btn-submit-news" class="btn btn-success">Add</button>
    ...
    <div class="modal-dialog modal-dialog-centered  modal-lg">
      <div class="modal-content">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
          ...
          <div class="modal-footer">
              <button type="submit" name="btn-edit-news" id="btn-edit-news" class="btn btn-success">Update</button>
              <button type="reset" class="btn btn-danger">Reset</button> 
          </div>
        </form>
      </div>
