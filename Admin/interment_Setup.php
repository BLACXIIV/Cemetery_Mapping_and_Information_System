...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Internmet Setup | Holy Gardens Matutum Memorial Park</title>
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#preview-deed-of-sale-<?php echo $row['lot_owner_id']?>">
                                    ...
                                    <tbody>
                                      <?php while($row=$sql_dead->fetch_array()){ ?>
                                        <tr>
                                          ...
                                          <td class="align-middle text-center">
                                            <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#preview-death-cert-<?php echo $row["deceased_id"]?>">
                                              <i class="bx bxs-file"></i>
                                            </button>
                                          </td>
                                          <td class="align-middle text-center">
        ...
        <div class="modal-content">
          ...
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-footer">
              <button type="submit" class="btn btn-success btn-update-owner-setup" name="btn-update-owner-setup" data-id="<?php echo $row["lot_owner_id"]?>">Update</button>
